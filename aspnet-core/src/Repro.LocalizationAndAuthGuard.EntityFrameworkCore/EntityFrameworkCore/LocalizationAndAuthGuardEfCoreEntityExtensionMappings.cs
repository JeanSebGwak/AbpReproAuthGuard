...
public static class LocalizationAndAuthGuardEfCoreEntityExtensionMappings
{
    ...
    public static void Configure()
    {
        ...
        OneTimeRunner.Run(() =>
        {
                 ...
                 * USE LocalizationAndAuthGuardModuleExtensionConfigurator CLASS (in the Domain.Shared project)
