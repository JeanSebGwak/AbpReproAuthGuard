...
namespace Repro.LocalizationAndAuthGuard.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("LocalizationAndAuthGuard") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "LocalizationAndAuthGuard", DisplayName = "LocalizationAndAuthGuard API", Resources = { "LocalizationAndAuthGuard" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        var consoleAndAngularClientId = configurationSection["LocalizationAndAuthGuard_App:ClientId"];
        if (!consoleAndAngularClientId.IsNullOrWhiteSpace())
        {
            var consoleAndAngularClientRootUrl = configurationSection["LocalizationAndAuthGuard_App:RootUrl"]?.TrimEnd('/');
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["LocalizationAndAuthGuard_Swagger:ClientId"];
        if (!swaggerClientId.IsNullOrWhiteSpace())
        {
            var swaggerRootUrl = configurationSection["LocalizationAndAuthGuard_Swagger:RootUrl"]?.TrimEnd('/');
